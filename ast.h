...
void print_ast_list(FILE *, ast_list *L, char *sep, int d);
int ste_const_value(STEntry *e);   // Return the value of the constant recorded in entry e
char *ste_name(STEntry *e);		   // Return the name of the object recorded in entry e
STE_TYPE ste_var_type(STEntry *e); // Return the type of the variable recorded in entry e
